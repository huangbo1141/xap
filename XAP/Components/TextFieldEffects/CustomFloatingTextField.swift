 ...
 */
public class CustomFloatingTextField: TextFieldEffects {
     ...
     */
    dynamic public var borderInactiveColor: UIColor? {
        didSet {
            updateBorder()
        }
    }
    ...
    /**
     ...
     This property applies a color to the lower edge of the control. The default value for this property is a clear color.
     */
    dynamic public var borderActiveColor: UIColor? {
        didSet {
            updateBorder()
        }
    }
     ...
     */
    dynamic public var placeholderColor: UIColor = .black {
        didSet {
            updatePlaceholder()
        }
    }
     ...
     */
    dynamic public var placeholderFontScale: CGFloat = 0.65 {
        didSet {
            updatePlaceholder()
        }
    }
