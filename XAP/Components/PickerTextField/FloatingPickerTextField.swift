...
protocol FloatingPickerTextFieldDelegate {
    func floatingPickerTextField(_ pickerField: FloatingPickerTextField, didSelectedRow selectedRow: Int, selectedValue value: String)
}

public class FloatingPickerTextField: CustomFloatingTextField, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
    @available(iOS 2.0, *)
    ...
    var pickerFieldDelegate : FloatingPickerTextFieldDelegate? = nil
    ...
    private func createPicker() {
        ...
        let doneButton = UIBarButtonItem(title: "Done".localizedString, style: UIBarButtonItemStyle.done, target: self, action: #selector(FloatingPickerTextField.donePressed))
    ...
    public func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        pickerFieldDelegate?.floatingPickerTextField(self, didSelectedRow: row, selectedValue: self.text!)
    }
