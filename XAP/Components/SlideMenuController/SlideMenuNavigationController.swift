...
//  Trax
//
//  Created by Swift Coder on 10/22/16.
...
@objc public protocol SlideMenuNavigationControllerDelegate {
...
public struct SlideMenuNavigationOptions {
...
open class SlideMenuNavigationController: UINavigationController, UIGestureRecognizerDelegate {
    ...
    open weak var slideMenuDelegate: SlideMenuNavigationControllerDelegate?
    ...
    open func initView() {
        ...
        if leftViewController != nil {
            ...
            view.insertSubview(leftContainerView, aboveSubview: navigationBar)
            addLeftGestures()
        }
        ...
        if rightViewController != nil {
            ...
            view.insertSubview(rightContainerView, aboveSubview: navigationBar)
            addRightGestures()
        }
    }
    ...
    open override func openLeft() {
        ...
        self.slideMenuDelegate?.leftWillOpen?()
    ...
    open override func openRight() {
        ...
        self.slideMenuDelegate?.rightWillOpen?()
    ...
    open override func closeLeft() {
        ...
        self.slideMenuDelegate?.leftWillClose?()
    ...
    open override func closeRight() {
        ...
        self.slideMenuDelegate?.rightWillClose?()
    ...
    open func openLeftWithVelocity(_ velocity: CGFloat) {
        ...
        UIView.animate(withDuration: duration, delay: 0.0, options: UIViewAnimationOptions(), animations: { [weak self]() -> Void in
            ...
            if let strongSelf = self {
                ...
                strongSelf.slideMenuDelegate?.leftDidOpen?()
            }
        }
    }
    ...
    open func openRightWithVelocity(_ velocity: CGFloat) {
        ...
        UIView.animate(withDuration: duration, delay: 0.0, options: UIViewAnimationOptions(), animations: { [weak self]() -> Void in
            ...
            if let strongSelf = self {
                ...
                strongSelf.slideMenuDelegate?.rightDidOpen?()
            }
        }
    }
    ...
    open func closeLeftWithVelocity(_ velocity: CGFloat) {
        ...
        UIView.animate(withDuration: duration, delay: 0.0, options: UIViewAnimationOptions(), animations: { [weak self]() -> Void in
            ...
            if let strongSelf = self {
                ...
                strongSelf.leftViewController?.endAppearanceTransition()
                strongSelf.slideMenuDelegate?.leftDidClose?()
            }
        }
    }
    ...
    open func closeRightWithVelocity(_ velocity: CGFloat) {
        ...
        UIView.animate(withDuration: duration, delay: 0.0, options: UIViewAnimationOptions(), animations: { [weak self]() -> Void in
            ...
            if let strongSelf = self {
                ...
                strongSelf.enableContentInteraction()
                strongSelf.rightViewController?.endAppearanceTransition()
                strongSelf.slideMenuDelegate?.rightDidClose?()
            }
        }
    }
...
extension UINavigationController {
    ...
    public func SlideMenuNavigationController() -> SlideMenuNavigationController? {
        var viewController: UIViewController? = self
        while viewController != nil {
            if viewController is SlideMenuNavigationController {
                return viewController as? SlideMenuNavigationController
            }
    ...
    public override func addLeftBarButtonWithImage(_ buttonImage: UIImage) {
        let leftButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItemStyle.plain, target: self, action: #selector(self.toggleLeft))
        navigationItem.leftBarButtonItem = leftButton;
    }
    
    public override func addRightBarButtonWithImage(_ buttonImage: UIImage) {
    ...
    public override func toggleLeft() {
        SlideMenuNavigationController()?.toggleLeft()
    }
    
    public override func toggleRight() {
        SlideMenuNavigationController()?.toggleRight()
    }
    
    public override func openLeft() {
        SlideMenuNavigationController()?.openLeft()
    }
    
    public override func openRight() {
        SlideMenuNavigationController()?.openRight()
    }
    
    public override func closeLeft() {
        SlideMenuNavigationController()?.closeLeft()
    }
    
    public override func closeRight() {
        SlideMenuNavigationController()?.closeRight()
    }
    
    // Please specify if you want menu gesuture give priority to than targetScrollView
    public override func addPriorityToMenuGesuture(_ targetScrollView: UIScrollView) {
        guard let slideController = SlideMenuNavigationController(), let recognizers = slideController.view.gestureRecognizers else {
            return
        }
